...
public class bl_WaitingRoom : bl_WaitingRoomBase, IMatchmakingCallbacks, IInRoomCallbacks
{
    ...
    public void LoadMap()
    {
        // print("This is scene: " + (string)PhotonNetwork.CurrentRoom.CustomProperties[PropertiesKeys.CustomSceneName]);
        //  bl_UtilityHelper.LoadLevel((string)PhotonNetwork.CurrentRoom.CustomProperties[PropertiesKeys.CustomSceneName]);
        SceneManager.LoadScene(1);
